...
```{r fig.margin = TRUE, fig.cap = "A neuron", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
...
So this little circle, which is a single neuron in a neural network, implements this function that we drew on the left. And all what the neuron does is: it inputs the size, computes this linear function, takes a max of zero, and then outputs the estimated price. 

```{r fig.margin = TRUE, fig.cap = "ReLU", fig.width=3.0, fig.height=3.0, cache=TRUE, echo=FALSE}
...
```{r fig.margin = FALSE, fig.cap = "Neural Network Inputs", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
