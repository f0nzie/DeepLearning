...
`r newthought('So, what exactly is a Neural Network?')`
...
```{r house_price, fig.margin = TRUE, fig.cap = "Logistic Regression parameters", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
knitr::include_graphics("./images/what_house.jpg")
```
...
```{r fig.margin = TRUE, fig.cap = "We have as the input to the neural network the **size** of a house which one we call $x$, it goes into this node, this little circle, and then it outputs the **price** which we call $y$.", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
knitr::include_graphics("./images/what_neuron.jpg")
```
...
```{r fig.margin = TRUE, fig.cap = "ReLU", fig.width=3.0, fig.height=3.0, cache=TRUE, echo=FALSE, out.width="80%"}
knitr::include_graphics("./images/what_relu.png")
```
...
```{r fig.margin = FALSE, fig.cap = "More features", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
knitr::include_graphics("./images/what_housing_more_features.jpg")
```
...
```{r fig.margin = TRUE, fig.cap = "larger neural network", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
knitr::include_graphics("./images/what_neural_net2.jpeg")
```
...
```{r fig.margin = FALSE, fig.cap = "Neural Network with four inputs", fig.width=2.5, fig.height=2.5, cache=TRUE, echo=FALSE, out.width="80%"}
knitr::include_graphics("./images/what_nn_inputs.jpg")
```
...
```{r fig.margin = TRUE, fig.cap = "Hidden units", fig.width=3.5, fig.height=3.5, cache=TRUE, echo=FALSE}
knitr::include_graphics("./images/what_hidden.jpg")
```
