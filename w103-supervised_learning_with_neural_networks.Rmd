...
```{r fig.fullwidth = TRUE, fig.cap = "Supervised Learning", cache=TRUE, echo=FALSE, out.width="60%"}
knitr::include_graphics("./images/sup_supervised_learning.png")
```
# Supervised Learning
...
```{r fig.fullwidth = TRUE, fig.cap = "Neural Network Examples", cache=TRUE, echo=FALSE, out.width="60%"}
knitr::include_graphics("./images/sup_nn_examples.png")
```
...
```{r fig.margin = TRUE, fig.cap = "Structured data", fig.width=3.0, fig.height=3.0, cache=TRUE, echo=FALSE, out.width="100%"}
knitr::include_graphics("./images/sup_structured.png")
```
...
## Uses of structured and unstructured data
...
# Why neural networks are working so well today
