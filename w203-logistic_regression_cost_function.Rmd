...
And, so, just to expand this out, this is equal to this^[$$-\dfrac{1}{m} \sum_{i=1}^m [\hat y^{(i)} \log y^{(i)} + (1 - y^{(i)}) \log (1 - \hat y^{(i)})]$$]. I guess I could put square brackets here. So the minus sign is outside everything else. 
