...
```{r fig.margin = TRUE, fig.cap = "Here is an example of binary classification problem", fig.width=4.5, fig.height=4.5, cache=TRUE, echo=FALSE}
knitr::include_graphics("./images/bin_cats_0_1.png")
```
...
knitr::include_graphics("./images/bin_rgb.png")
```
